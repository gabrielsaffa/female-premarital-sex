...
pop <- norms2$Population # store population column into an object

norms2[c(18,27,29,30,32,33,35,36,43,44,45,46,49,53,54,55,119,143),12] <- 7 # change to indirect dowry; see Schlegel (1991)
...
norms <- read.csv ("norms_red_final.csv", header=TRUE, row.names=1)
...
tree <- read.tree ("SPT.SCCS_red.tre") # load the phylogeny
