...
setwd ("E:/sex norms/norms resubmission")
...
### model with marriage transactions predictors excluded ###
...
traceplot (m_norm_no_marr, pars=c("cutpoints","bD","bGE","bBP","bPloc","bDM","bMA","bSR","bDC","bI","bEX","sigma"))
